          ...
          <div class="breadcrumbs ace-save-state" id="breadcrumbs">
					...
					<form action="/ssm/studentModify" method="post">
							...
							<div class="form-group" style="background-color:white">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" name="name" value="${list.name }" placeholder="输入姓名" class="col-xs-10 col-sm-5" />
										</div>
									</div>
						...
						<!-- 选择性别 -->
								<div class="col-xs-12 col-sm-6">
											<div class="control-group">
												<label class="control-label bolder blue">性别</label>
...
<!-- 选修课目 -->
	            <div class="col-xs-12 col-sm-5">
											<div class="control-group">
												<label class="control-label bolder blue">科目选择</label>
...
<div class="widget-body" style="margin-left: -700px;width:800px">
													<div class="widget-main">
														<label for="id-date-picker-1">出生日期</label>

														<div class="row">
															<div class="col-xs-8 col-sm-11">
																<div class="input-group">
																	<input class="form-control date-picker" name="age" id="id-date-picker-1" type="text" data-date-format="dd-mm-yyyy" value="${list.age }"/>
...
<!-- 所在班级 -->
										<div class="widget-body" style="margin-left: -700px;width:800px">
													<div class="widget-main">
														<div>
															<label for="form-field-select-1">班级选择</label>

															<select class="form-control" id="form-field-select-1" name="classes">
																
																<option value="一班" <c:if test="${list.classes=='一班' }"> selected</c:if>>一班</option>
																<option value="二班" <c:if test="${list.classes=='二班' }"> selected</c:if>>二班</option>
																<option value="三班" <c:if test="${list.classes=='三班' }"> selected</c:if>>三班</option>
																<option value="四班" <c:if test="${list.classes=='四班' }"> selected</c:if>>四班</option>
